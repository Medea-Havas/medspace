...
<div class="<?php learndash_the_wrapper_class(); ?>">
  ...
  <div id="ld-profile"
    data-shortcode_instance="<?php echo $learndash_shortcode_data_json; ?>">
    <?php
        /**
      ...
      <div class="ld-profile-card">
        <div class="ld-profile-avatar">
          <?php
                         ...
                         */
                        echo "<a href='https://es.gravatar.com' target='_blank'>" . wp_kses_post(get_avatar($user_id, 150)) . "</a>";
            ?>
        </div>
        <!--/.ld-profile-avatar-->
        <?php
        ...
        <div>
          <a class="ld-profile-edit-link"
            href='<?php echo esc_url(site_url() . '/usuario/editar'); ?>'><?php esc_html_e('Edit profile', 'learndash'); ?></a>
          <a class="ld-profile-edit-link"
            href='<?php echo esc_url(site_url() . '/wp-login.php?action=logout&redirect_to=' . site_url()); ?>'>Salir</a>
        </div>
        <?php endif; ?>
      </div>
      <!--/.ld-profile-card-->
...
?>
    ...
    esc_attr(LearnDash_Custom_Label::get_label('courses'))
          ...
          <div class="ld-expand-button" data-ld-expands="ld-main-course-list"
            ...
            <span
              class="ld-text"><?php echo esc_html_e('Expand All', 'learndash'); ?></span>
          </div>
          <!--/.ld-expand-button-->
        </div>
...
?>
      ...
      <div class="ld-item-list-items" id="ld-main-course-list" data-ld-expand-list="true"
        data-ld-expand-id="<?php echo esc_attr('ld-main-course-list'); ?>">
