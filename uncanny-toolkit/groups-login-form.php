<aside id="uo-widgets" class="sidebar-login-form clr">
	<div class="clr widget">
		<div class="widget-title"><?php esc_html_e('Log In', 'uncanny-pro-toolkit') ?>
		</div>
		<?php
        if (defined('PWP_NAME')) {
            ?>
		<form name="uncanny-pro-toolkit-login-form" id="uncanny-pro-toolkit-login-form"
			action="<?php echo wp_login_url(); ?>?wpe-login=<?php echo PWP_NAME; ?>"
			method="post">
			<?php } else { ?>
			<form name="uncanny-pro-toolkit-login-form" id="uncanny-pro-toolkit-login-form"
				...
				<p class="login-remember">
					<label>
						<input name="rememberme" type="checkbox" id="rememberme" value="forever"><?php esc_html_e('Remember Me', 'uncanny-pro-toolkit') ?>
					</label>
				</p>
				<p class="login-submit">
					<input type="submit" name="wp-submit" id="wp-submit" class="button-primary"
						value="<?php esc_html_e('Log In', 'uncanny-pro-toolkit') ?>">
				</p>
