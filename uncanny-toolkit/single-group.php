...
<div id="main-content">
  <div id="group-main" class="page type-page status-publish hentry">
                    ...
                    if ($group_query->have_posts()) :
                        while ($group_query->have_posts()) :
                            ...
                            if (! isset($_GET[ $group_key ])) {
                                ?>
          <p><?php echo esc_html__('This page can only be used by organizations with a valid group ID. The URL used to reach this page is not valid. Please contact your organization to obtain the correct registration URL.', 'uncanny-pro-toolkit'); ?>
          </p>
          <?php
          ...
          <article <?php post_class(); ?>>
            ...
            <?php
                                            ...
                                            if (! empty($frontEndLogin) && 'on' === $frontEndLogin) {
                                                ?>
            <p><?php echo esc_html__('Thank you for registering. Your account needs to be approved by site administrator.', 'uncanny-pro-toolkit'); ?>
            </p>
            <?php } else { ?>
            <p><?php echo esc_html__('Congratulations! You are now registered on this site. You will receive an email shortly with login details.', 'uncanny-pro-toolkit'); ?>
            </p>
            <?php } ?>
            <?php
                                        }
                                    } elseif (is_user_logged_in() && isset($_REQUEST['registered'])) {
                                        echo "<script>window.location.href = '" . site_url() . "/medspace/usuario'</script>";
    ...
    ?>
          <p><?php echo esc_html__('Page not found.', 'uncanny-pro-toolkit'); ?>
          </p>
          <?php
endif;
?>
